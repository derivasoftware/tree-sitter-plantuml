...
| `SREQ-00002-1` | `REQ-00002-2`<br>`REQ-00003-3`<br>`REQ-00004-1`<br>`REQ-00005-3`<br>`REQ-00006-1`<br>`REQ-00010-4`<br>`REQ-00011-2`<br>`REQ-00013-1`<br>`REQ-00014-1`<br>`REQ-00020-1`<br>`REQ-00021-1`<br>`REQ-00022-1`<br>`REQ-00023-1`<br>`REQ-00028-3` | `CL_ClassChapter`<br>`CL_Envelope`<br>`CL_Grouping`<br>`CL_Members`<br>`CL_Notes`<br>`CL_Relations` | `ClassChapter`<br>`Envelope`<br>`Grouping`<br>`Members`<br>`Notes`<br>`Relations` | 11 | 1 | `VER-00004-1`<br>`VER-00005-2`<br>`VER-00006-1`<br>`VER-00007-1`<br>`VER-00008-1`<br>`VER-00010-1`<br>`VER-00011-1`<br>`VER-00012-1`<br>`VER-00013-1`<br>`VER-00019-1`<br>`VER-00020-1`<br>`VER-00021-1`<br>`VER-00022-1`<br>`VER-00029-3` |
